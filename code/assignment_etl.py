...
PLACE_IDS_SOURCE_FILE = os.path.join(BASE_DIR, "cache", "place_ids.csv")
CACHE_REVIEWS_FILE = os.path.join(BASE_DIR, "cache", "reviews.csv")
CACHE_SENTIMENT_FILE = os.path.join(BASE_DIR, "cache", "reviews_sentiment_by_sentence.csv")
CACHE_ENTITIES_FILE = os.path.join(BASE_DIR, "cache", "reviews_sentiment_by_sentence_with_entities.csv")
